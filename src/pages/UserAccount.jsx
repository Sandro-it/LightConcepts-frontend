          ...
          <div className={styles.container}>
                ...
                <form onSubmit={handleUpdateUser}>
                        <div className={styles.formGroup}>
                                  <label htmlFor="username">Ім'я</label>label>
                                  <input
                                                type="text"
                                                id="username"
                                                name="username"
                        ...
                        <div className={styles.formGroup}>
                                  <label htmlFor="email">Електронна пошта</label>label>
                                  <input
                                                type="email"
                                                id="email"
                                                name="email"
                        ...
                        <button type="submit">Оновити дані</button>button>
                </form>form>
          
            {passwordChanged ? (
                    <div className={styles.formGroup}>
                              <p className={styles.message}>{message}</p>p>
                    ...
                    <form onSubmit={handlePasswordSubmit}>
                              <div className={styles.formGroup}>
                                          <label htmlFor="currentPassword">Поточний пароль</label>label>
                                          <input
                                                          type="password"
                                                          id="currentPassword"
                                ...
                                {errors.currentPassword && (
                                    <span className={styles.error}>{errors.currentPassword}</span>span>
                                          )}
                              </div>div>
                              <div className={styles.formGroup}>
                                          <label htmlFor="newPassword">Новий пароль</label>label>
                                          <input
                                                          type="password"
                                                          id="newPassword"
                                                          name="newPassword"
                                                        ...
                                                        />
                                {errors.newPassword && (
                                    <span className={styles.error}>{errors.newPassword}</span>span>
                                          )}
                              </div>div>
                              <div className={styles.formGroup}>
                                          <label htmlFor="confirmPassword">Підтвердьте новий пароль</label>label>
                                          <input
                                                          type="password"
                                                          id="confirmPassword"
                                ...
                                {errors.confirmPassword && (
                                    <span className={styles.error}>{errors.confirmPassword}</span>span>
                                          )}
                              </div>div>
                              <button type="submit">Змінити пароль</button>button>
                      {message && <p className={styles.message}>{message}</p>p>}
                    </form>form>
                )}
          </div>div>
        );
